...
extern graph_t *new_graph(vertex_t *v){
    graph_t *g = util_malloc(1);
    g->g = v;
    g->nv = 0;
    g->ne = 0;
    return g;
...
extern void remove_edge(graph_t *g,int i, int j){
...
extern void graph_all_white_vertices(graph_t *g){
    vertex_t *v;
...
extern edge_t *graph_find_edge(graph_t *g, int i,int j){
    edge_t *e;
    vertex_t *v = graph_find(g,i);
